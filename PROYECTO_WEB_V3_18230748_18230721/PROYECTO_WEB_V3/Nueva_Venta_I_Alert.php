...
<body> 
    ...
    <?php
    echo "SE EXCEDIO LA EXSTENCIA DEL PRODUCTO"; ?>
    </div>
    <style>
        label{
            margin-left: 10px;
...
<form action="" method="POST">
        ...
        <input type="text" name="precio" id="precio" value="<?php echo $filas['PRECIO_VENTA']?>"><br>
    ...
    <table class="table table-light">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="20%" class="text-center"><?php echo number_format($producto['precio']*$producto['cant'],2);?></td>
            ...
            <?php $total=$total+($producto['precio']*$producto['cant']);?>
            <?php }?>
            <tr>
